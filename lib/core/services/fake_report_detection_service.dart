...
''';
    ...
    print('FakeReportDetection: trying Groq');
    try {
      ...
      if (groqResult.isNotEmpty) {
        ...
        print('FakeReportDetection: Groq succeeded');
        return {
          'isGenuine': isGenuine,
      ...
      print('FakeReportDetection: Groq failed: $e');
    }

    print('FakeReportDetection: Groq failed, trying Gemini');
    ...
    for (var model in geminiModels) {
      try {
        ...
        print('FakeReportDetectionService: try model=$model');
        ...
        print('FakeReportDetectionService exception: $e');
        continue;
      }
    }
